...
$key .bbp-reply-content, $key .bbp-topic-content{ background:$bg; }

$key .bbp-topics .bbp-header, $key .bbp-topics .bbp-header, $key .bbp-forums .bbp-header, $key .bbp-topics-front ul.super-sticky, $key .bbp-topics ul.super-sticky, $key .bbp-topics ul.sticky, $key .bbp-forum-content ul.sticky{
background-color:$bg2;
}

$key .bbp-meta, $key .bbp-author-role, $key .bbp-author-ip, $key .bbp-pagination-count, .single-forum $key .bbp-body .bbp-topic-title:before{
color: $meta;
}
