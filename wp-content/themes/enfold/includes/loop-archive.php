		...
		<div class='post-entry'>
	        ...
	        <div class="blog-meta grid3">
				...
				<span class='post-date-comment-container'>
					<span class='date-container updated'><strong><?php the_time('d') ?> <?php the_time('M') ?></strong><span><?php the_time('Y') ?></span></span>
...
?>
	...
	<div class="entry">
		...
		<p class="entry-content"><?php _e('Sorry, no posts matched your criteria', 'avia_framework'); ?></p>
	</div>
<?php
